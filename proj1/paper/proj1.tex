...
Our experiment was conducted with 30 trials for each dataset using 10-fold cross validation for each trial, to provide the data presented in \ref{fig:good} and \ref{fig:ugly}. 
The mean log loss and 0/1 loss values for each dataset after 30 trials can be found in the following table (where data with permutations is denoted by *):

\begin{center}
 \begin{tabular}{|c c c c c c c c c c c|} 
 \hline
 Loss Function & Vote & Vote* & Cancer & Cancer*& Glass & Glass* & Iris & Iris* & Soy & Soy*\\ [0.5ex] 
 \hline\hline
 0/1 Loss & 0.1041 & 0.1126 & 0.0348 & 0.0458  & 0.2206 & 0.4297 & 0.2654 & 0.2092 & 0.4300 & 0.4350\\ 
 \hline
 Log Loss & 0.5809 & 0.4401 & 0.1890 & 0.2116 & 0.5194 & 0.7116 & 0.3633 & 0.3840 & 1.6919 & 1.706\\  
 \hline
\end{tabular}
\end{center}
