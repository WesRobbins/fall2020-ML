...
\jmlrheading{1}{2020}{1-48}{4/00}{10/00}{Ben Holmgren, Wes Robbins, and Seth Bassetti}

% Short headings should be running head and authors last names

\ShortHeadings{Learning with Mixtures of Trees}{Holmgren, Robbins, and Bassetti}
\firstpageno{1}
